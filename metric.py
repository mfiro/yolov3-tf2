...
def mAP(gt_path, dr_path, img_path):
    ...
    gt_counter_per_class, counter_images_per_class, ground_truth_files_list = save_gt_as_json(gt_path, f"{TEMP_FILES_PATH}/gt")
...
def mAP_old(gt_path, dr_path, img_path):
    MINOVERLAP = 0.5 # default value (defined in the PASCAL VOC2012 challenge)
    '''
        0,0 ------> x (width)
        |
